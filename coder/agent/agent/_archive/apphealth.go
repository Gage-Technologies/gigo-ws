...
// TODO: determine if we want to have an app model reporting system

// // WorkspaceAgentApps fetches the workspace apps.
// type WorkspaceAgentApps func(context.Context) ([]agentsdk.WorkspaceApp, error)
//
// // PostWorkspaceAgentAppHealth updates the workspace app health.
// type PostWorkspaceAgentAppHealth func(context.Context, agentsdk.PostWorkspaceAppHealthsRequest) error
//
...
// func NewWorkspaceAppHealthReporter(logger slog.Logger, apps []agentsdk.WorkspaceApp, postWorkspaceAgentAppHealth PostWorkspaceAgentAppHealth) WorkspaceAppHealthReporter {
...
// 		health := make(map[uuid.UUID]agentsdk.WorkspaceAppHealth, 0)
// 		for _, app := range apps {
// 			if app.Health == agentsdk.WorkspaceAppHealthDisabled {
// 				continue
// 			}
...
// 							health[app.ID] = agentsdk.WorkspaceAppHealthUnhealthy
// 						}
// 						mu.Unlock()
// 					} else {
// 						mu.Lock()
// 						// we only need one successful health check to be considered healthy.
// 						health[app.ID] = agentsdk.WorkspaceAppHealthHealthy
// 						failures[app.ID] = 0
// 						mu.Unlock()
// 					}
//
...
// 				lastHealth = copyHealth(health)
// 				mu.Unlock()
// 				err := postWorkspaceAgentAppHealth(ctx, agentsdk.PostWorkspaceAppHealthsRequest{
// 					Healths: lastHealth,
// 				})
// 				if err != nil {
...
// }
//
// func shouldStartTicker(app agentsdk.WorkspaceApp) bool {
// 	return app.Healthcheck.URL != "" && app.Healthcheck.Interval > 0 && app.Healthcheck.Threshold > 0
// }
//
// func healthChanged(old map[uuid.UUID]agentsdk.WorkspaceAppHealth, new map[uuid.UUID]agentsdk.WorkspaceAppHealth) bool {
...
// }
//
// func copyHealth(h1 map[uuid.UUID]agentsdk.WorkspaceAppHealth) map[uuid.UUID]agentsdk.WorkspaceAppHealth {
// 	h2 := make(map[uuid.UUID]agentsdk.WorkspaceAppHealth, 0)
// 	for k, v := range h1 {
// 		h2[k] = v
// 	}
//
